    ...
    <section id="manufacturing" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Manufacturing Process</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="flex flex-col justify-center">
            <h3 className="text-3xl font-bold text-gray-900 mb-6">Our Manufacturing Excellence</h3>
            ...
            <div className="grid grid-cols-2 gap-4">
              {features.map((feature, index) => (
                <div key={index} className="flex items-start">
                  <div className="w-2 h-2 bg-red-900 rounded-full mt-2 mr-3 flex-shrink-0"></div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {processes.map((process, index) => (
            <div key={index} className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              <div className="w-16 h-16 bg-gradient-to-br from-red-900 to-red-700 rounded-lg flex items-center justify-center mb-6">
        ...
        <div className="mt-16 bg-gradient-to-r from-red-900 to-red-700 rounded-2xl p-8 md:p-12 text-white">
